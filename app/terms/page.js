...
export default function Terms() {
  return (
    <div style={{ margin: 25 }} className="align-left font-Poppins">
      <header className="flex bg-white min-h-screen flex-col items-center">
        <h1 className="font-bold text-4xl my-4">All Points Collision Center</h1>
        <div className="w-3/4 mx-12">
          <h1 className="font-bold text-2xl mb-2">Terms and Conditions</h1>
          <p className="my-4">Last updated: March 20, 2024</p>
          <p className="my-4">
          ...
          <h3 className="font-semibold text-lg mb-2">Definitions</h3>
          <p className="my-4">
          ...
          <p className="my-4">
            ...
            downloaded by You on any electronic device, named APCC - Crash App.
            ...
            available by the Service. You means the individual accessing or
          ...
          {/* </ul> */}
          <h2 className="font-semibold text-xl mb-2">Acknowledgment</h2>
          <p className="my-4">
          ...
          <h2 className="font-semibold text-xl mb-2">User Accounts</h2>
          <p className="my-4">
          ...
          <h2 className="font-semibold text-xl mb-2">Termination</h2>
          <p className="my-4">
          ...
          <h2 className="font-semibold text-xl mb-2">Governing Law</h2>
          <p className="my-4">
          ...
          <h2 className="font-semibold text-xl mb-2">Disputes Resolution</h2>
          <p className="my-4">
          ...
          <ul className="list-disc pl-5 my-4">
            <li className="my-2">By email: support@onesource.tech</li>
            <li className="my-2">
              By mail: 11700 Space Center Blvd #106, Houston, TX 77059
            </li>
          </ul>
        </div>
      </header>
