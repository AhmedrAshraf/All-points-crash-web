    ...
    <div style={{ margin: 25 }} className="align-left font-Poppins">
      <header className="flex bg-white min-h-screen flex-col items-center">
        ...
        <div className="w-3/4 mx-12">
          ...
          <p className="my-4">
            Application refers to APCC - Crash App, the software program
          ...
          <p className="my-4">Country refers to: Texas, United States</p>
          <p className="my-4">
          ...
          <p className="my-4">
            ...
            agency). Other legal requirements
          </p>
          <p className="my-4">
            The Company may disclose Your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <p className="my-4">• Comply with a legal obligation</p>
          <p className="my-4">
          ...
          <p className="my-4">• Protect against legal liability</p>
          <h3 className="font-semibold text-lg mb-2">
          ...
          <p className="my-4">By email: support@onesource.tech</p>
          <p className="my-4">
            By visiting this page on our website: https://allpointscollision.com
          </p>
        </div>
      </header>
    </div>
